...
public class VeiculoVenderTableModel extends DefaultTableModel {
    ...
    public VeiculoVenderTableModel(List<Van> v, List<Motocicleta> m, List<Automovel> a) {
        this.listaVans = v;
    ...
    public void removeSelectedRows(JTable myJTable) {
        ...
        VeiculoVenderTableModel tableModel = (VeiculoVenderTableModel) myJTable.getModel();
        switch (tipoVeiculo) {
            case 1 -> {
