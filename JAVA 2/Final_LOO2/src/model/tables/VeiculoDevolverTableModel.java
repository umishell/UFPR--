...
public class VeiculoDevolverTableModel extends DefaultTableModel {
    ...
    public VeiculoDevolverTableModel(List<Van> v, List<Motocicleta> m, List<Automovel> a) {
        this.listaVans = v;
    ...
    public void removeSelectedRows(JTable myJTable) {
        ...
        VeiculoDevolverTableModel tableModel = (VeiculoDevolverTableModel) myJTable.getModel();
        switch (tipoVeiculo) {
            case 1 -> {
